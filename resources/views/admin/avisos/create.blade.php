...
@section('content')
	...
	<div class="container">
		...
		{!! Form::open(['route'=>'avisos.store', 'method'=>'POST','files'=>'true']) !!}
		...
		<div class="row">
  			<div class="col-md-8">
				...
				{!! Form::text('titulo',null,['class'=>'form-control','placeholder'=>'Tema','required']) !!}
				</div>

				<div class="form-group">
				{!! Form::label('aviso','Aviso*') !!}
				{!! Form::text('aviso',null,['class'=>'form-control','placeholder'=>'Dia','required']) !!}
				</div>
			</div>
